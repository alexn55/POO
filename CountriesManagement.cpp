...
public:
    ...
    void calcCoefMediu()
    {
        this->coeficientMediu = (this->coef_economic + Tara().calcCoef())/2;
    }

    Uniune& operator=(const Uniune& t)
    {
        if (this != &t)
        {
            Tara::operator=(t);
            this->coeficientMediu = t.coeficientMediu;
        }
        return *this;
    }
...
public:
    ...
    void calcInflatiaMedie()
    {
        this->inflatie_medie = (this->inflatie_medie + Tara().getInflatia()) / 2;
    }
...
public:
    ...
    void launch()
    {
        ...
        Tara t;
        Uniune u;
        SpatiuEconomic* se = new SpatiuEconomic();
        int i;
        string n;
        ...
        while (ok == true)
        {
            ...
            switch (alegere)
            {
                ...
                case 7:
                {
                    ...
                    if (i == 1 && UE.getCoefM() < t.getCoefEcnom())
                    {
                        cout << "Tara a iesit din UE!" << endl;
                        UE.getCoefM() = UE.getCoefM() * 2 - t.getCoefEcnom();
                    }
                    else if (i == 2 && ASEAN.getCoefM() < t.getCoefEcnom())
                    {
                        cout << "Tara a iesit din ASEAN!" << endl;
                        ASEAN.getCoefM() = ASEAN.getCoefM() * 2 - t.getCoefEcnom();
                    }
                    else if (i == 3 && NAFTA.getCoefM() < t.getCoefEcnom())
                    {
                        cout << "Tara a iesit din NAFTA!" << endl;
                        NAFTA.getCoefM() = NAFTA.getCoefM() * 2 - t.getCoefEcnom();
                    }
                ...
                case 8:
                {
                    float inflatieMedieNew = (Schengen.getInflatieMedie() + t.getInflatia()) / 2;
                    se->setInflatieMedie(inflatieMedieNew);
                    if (t.getInflatia() < 3 && se->getInflatieMedie() > t.getInflatia())
                    {
                        cout << "Tara a iesit din spatiul economic." << endl;
                         float inflatieMedie = se->getInflatieMedie() * 2 - t.getInflatia();
                         se->setInflatieMedie(inflatieMedie);
                    }
